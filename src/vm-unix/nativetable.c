...
// int MiddlewareService.getRegisteredSlots()
Cell MagolvesMqtt_MiddlewareService_getRegisteredSlots(SedonaVM* vm, Cell* params);
...
NativeMethod kitNatives51[] = 
{
  ...
  MagolvesMqtt_MiddlewareService_getRegisteredSlots,  // 51::15
  MagolvesMqtt_MiddlewareService_unregisterSlot,  // 51::16
  MagolvesMqtt_MiddlewareService_enableComponentIf,  // 51::17
  MagolvesMqtt_MiddlewareService_enableSlotIf,  // 51::18
  MagolvesMqtt_MiddlewareService_isSlotEnabled,  // 51::19
};
