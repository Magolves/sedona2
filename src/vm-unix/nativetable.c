...
// bool CbcMiddlewareService.exportMonitor(sys::Obj, sys::Component, sys::Slot, sys::Str)
Cell MagolvesMqtt_CbcMiddlewareService_exportMonitor(SedonaVM* vm, Cell* params);

// bool CbcMiddlewareService.exportParameter(sys::Obj, sys::Component, sys::Slot, sys::Str)
Cell MagolvesMqtt_CbcMiddlewareService_exportParameter(SedonaVM* vm, Cell* params);

// bool CbcMiddlewareService.exportAction(sys::Obj, sys::Component, sys::Slot, sys::Str)
...
NativeMethod kitNatives51[] = 
{
  ...
  NULL,                           // 51::8
  NULL,                           // 51::9
  MagolvesMqtt_CbcMiddlewareService_exportMonitor,  // 51::10
  MagolvesMqtt_CbcMiddlewareService_exportParameter,  // 51::11
  MagolvesMqtt_CbcMiddlewareService_exportAction,  // 51::12
};
