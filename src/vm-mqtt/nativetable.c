...
////////////////////////////////////////////////////////////////
// communityMQTT (kitId=50)
////////////////////////////////////////////////////////////////

// sys::Obj Worker.startSession(sys::Str, int, sys::Str, sys::Str, sys::Str)
Cell communityMQTT_Worker_startSession(SedonaVM* vm, Cell* params);

// void Worker.stopSession(sys::Obj)
Cell communityMQTT_Worker_stopSession(SedonaVM* vm, Cell* params);

// bool Worker.isSessionLive(sys::Obj)
Cell communityMQTT_Worker_isSessionLive(SedonaVM* vm, Cell* params);

// void Message.doPublish(sys::Obj, sys::Str, sys::Str, int, int)
Cell communityMQTT_Message_doPublish(SedonaVM* vm, Cell* params);

// void Message.doSubscribe(sys::Obj, sys::Str, int)
Cell communityMQTT_Message_doSubscribe(SedonaVM* vm, Cell* params);

// void Message.doUnsubscribe(sys::Obj, sys::Str)
Cell communityMQTT_Message_doUnsubscribe(SedonaVM* vm, Cell* params);

// bool Message.fetchData(sys::Obj, sys::Str, sys::Str, int)
Cell communityMQTT_Message_fetchData(SedonaVM* vm, Cell* params);

// bool Message.regSlot(sys::Component, sys::Slot)
Cell communityMQTT_Message_regSlot(SedonaVM* vm, Cell* params);

// native table for kit 50
NativeMethod kitNatives50[] = 
{
  communityMQTT_Worker_startSession,  // 50::0
  communityMQTT_Worker_stopSession,  // 50::1
  communityMQTT_Worker_isSessionLive,  // 50::2
  communityMQTT_Message_doPublish,  // 50::3
  communityMQTT_Message_doSubscribe,  // 50::4
  communityMQTT_Message_doUnsubscribe,  // 50::5
  communityMQTT_Message_fetchData,  // 50::6
  NULL,                           // 50::7
  communityMQTT_Message_regSlot,  // 50::8
};
...
int isNativeIdValid(int kitId, int methodId)
{
  switch(kitId)
  {
    ...
    case 50:
      ...
      else return kitNatives50[methodId] != NULL;
    default:
       return 0;
  }
}
